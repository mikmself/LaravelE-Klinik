...
<head>
    ...
    <link href="/medic/css/owl.carousel.min.css" rel="stylesheet">
    <link href="/medic/css/owl.theme.default.min.css" rel="stylesheet">
    <link href="/medic/css/templatemo-medic-care.css" rel="stylesheet">
</head>
<body id="top">
<main>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('medic-record')}}">Medic Record</a>
                    </li>
                    @auth
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button type="submit" class="navbar-brand d-none d-lg-block" style="border: none; background: transparent">
                                Medic Care
                                <strong class="d-block">Logout</strong>
                            </button>
                        </form>
                    @elseguest
                        <a class="navbar-brand d-none d-lg-block" href="/login">
                            Medic Care
                    ...
                    <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/medic/images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg" class="img-fluid" alt="">
                            </div>

                            <div class="carousel-item">
                                <img src="/medic/images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg" class="img-fluid" alt="">
                            </div>

                            <div class="carousel-item">
                                <img src="/medic/images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-6 ps-0">
                    <img src="/medic/images/gallery/medium-shot-man-getting-vaccine.jpg" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                </div>

                <div class="col-lg-6 col-6 pe-0">
                    <img src="/medic/images/gallery/female-doctor-with-presenting-hand-gesture.jpg" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel reviews-carousel">
                        ...
                        <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                            ...
                            <img src="/medic/images/reviews/beautiful-woman-face-portrait-brown-background.jpeg" class="img-fluid reviews-image" alt="">
                        ...
                        <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                            ...
                            <img src="/medic/images/reviews/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg" class="img-fluid reviews-image" alt="">
                        ...
                        <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                            ...
                            <img src="/medic/images/reviews/portrait-british-woman.jpeg" class="img-fluid reviews-image" alt="">
                        ...
                        <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                            ...
                            <img src="/medic/images/reviews/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg" class="img-fluid reviews-image" alt="">
...
<script src="/medic/js/scrollspy.min.js"></script>
